...
Get_Single_Gene(Single_Analysis)$Gene
```
...
#Get candidate genes based on FDR threshold 0.05 for trait1
Get_Multi_Gene(Multi_Analysis)$Gene_trait1
#Get candidate genes based on FDR threshold 0.05 for trait2
Get_Multi_Gene(Multi_Analysis)$Gene_trait2
```
